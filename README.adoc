...
https://github.com/Floorp-Projects/Floorp[Floorp Browser]: https://github.com/Homebrew/homebrew-cask[Homebrew/homebrew-cask] needs more forks, watchers and stars to merge the cask. Can I possibly trouble you to help them please?